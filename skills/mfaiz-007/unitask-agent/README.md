...
1. In Unitask: `Dashboard -> Settings -> API` create an API token with scopes you need.
2. In your AI app / MCP client config, store token as `UNITASK_API_KEY` (never paste tokens in chat).
