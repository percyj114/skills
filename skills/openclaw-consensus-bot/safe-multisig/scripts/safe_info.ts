 ...
 */
import { addCommonOptions, createCommand, fetchJson, resolveTxServiceUrl, validateAddress, type SafeOptions } from './safe_lib.js';

const program = addCommonOptions(
  createCommand('safe_info', 'Fetch Safe info (owners/threshold/nonce) from Transaction Service')
)
